...
const ISSUE_TYPES = {
  ...
  stay_11kv: [
    { id:'stay_broken',   label:'Stay Wire Broken',    severity:'critical' },
    { id:'stay_loose',    label:'Stay Wire Loose',      severity:'high'     },
    { id:'anchor_fail',   label:'Anchor Plate Failed',  severity:'critical' },
    { id:'rusted',        label:'Rusted / Corroded',    severity:'medium'   },
    { id:'other',         label:'Other Issue',          severity:'medium'   },
  ],
  stay_33kv: [
    { id:'stay_broken',   label:'Stay Wire Broken',    severity:'critical' },
  ...
  lattice_36: [
    { id:'corrosion',     label:'Corrosion / Rust',    severity:'high'     },
    { id:'bent_member',   label:'Bent Member',          severity:'critical' },
    { id:'missing_bolt',  label:'Missing Bolt/Nut',     severity:'high'     },
    { id:'painting',      label:'Painting Required',    severity:'low'      },
    { id:'other',         label:'Other Issue',          severity:'medium'   },
  ],
  lattice_42: [
    { id:'corrosion',     label:'Corrosion / Rust',    severity:'high'     },
  ...
  rmu: [
    { id:'sf6_low',       label:'SF6 Pressure Low',    severity:'critical' },
    { id:'operate_fail',  label:'Operation Failure',    severity:'critical' },
    { id:'busbar_fault',  label:'Busbar Fault',         severity:'critical' },
    { id:'other',         label:'Other Issue',          severity:'medium'   },
  ],
  la: [
    { id:'flashover',     label:'Flashover Marks',     severity:'critical' },
    { id:'cracked',       label:'Cracked/Broken',       severity:'high'     },
    { id:'disconnect',    label:'Disconnected',         severity:'critical' },
    { id:'other',         label:'Other Issue',          severity:'medium'   },
  ],
  streetlight: [
    { id:'lamp_fail',     label:'Lamp Not Working',    severity:'medium'   },
    { id:'pole_damage',   label:'Pole Damaged',         severity:'high'     },
    { id:'wiring_fault',  label:'Wiring Fault',         severity:'high'     },
    { id:'other',         label:'Other Issue',          severity:'medium'   },
  ],
  dtr_sp: [
    { id:'dtr_burnt',     label:'DTR Burnt',            severity:'critical'},
