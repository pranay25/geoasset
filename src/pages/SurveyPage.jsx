...
const ASSET_FIELDS = {
  ...
  stay_11kv: [
    { id:'stay_type', label:'Stay Type', type:'select', options:['Single Stay','Double Stay','Flying Stay','Box Stay'] },
    { id:'wire_dia', label:'Wire Dia (mm)', type:'select', options:['7/8 SWG','7/10 SWG','7/12 SWG'] },
    { id:'anchor_type', label:'Anchor', type:'select', options:['Plate Anchor','Screw Anchor','Rock Anchor'] },
    { id:'condition', label:'Condition', type:'select', options:['Good','Rusted','Broken','Loose'] },
  ],
  stay_33kv: [
    { id:'stay_type', label:'Stay Type', type:'select', options:['Single Stay','Double Stay','Flying Stay','Box Stay'] },
    { id:'wire_dia', label:'Wire Dia (mm)', type:'select', options:['7/8 SWG','7/10 SWG','7/12 SWG'] },
  ...
  lattice_36: [
    { id:'structure_type', label:'Structure Type', type:'select', options:['Tension Tower','Section Tower','Angle Tower','Terminal Tower'] },
    { id:'voltage_level', label:'Voltage Level', type:'select', options:['11kV','33kV','66kV'] },
    { id:'height_ft', label:'Height', type:'select', options:['36ft'] },
    { id:'body_type', label:'Body Type', type:'select', options:['Narrow Body','Wide Body'] },
    { id:'condition', label:'Condition', type:'select', options:['Good','Needs Painting','Corrosion','Damaged'] },
  ],
  lattice_42: [
    { id:'structure_type', label:'Structure Type', type:'select', options:['Tension Tower','Section Tower','Angle Tower','Terminal Tower'] },
    { id:'voltage_level', label:'Voltage Level', type:'select', options:['11kV','33kV','66kV'] },
    { id:'height_ft', label:'Height', type:'select', options:['42ft'] },
    { id:'body_type', label:'Body Type', type:'select', options:['Narrow Body','Wide Body'] },
    { id:'condition', label:'Condition', type:'select', options:['Good','Needs Painting','Corrosion','Damaged'] },
  ],
  ab_cable: [
    { id:'cable_type', label:'Cable Type', type:'select', options:['ABC 3.5 Core','ABC 4 Core','ABC 2 Core','LT ABC'] },
    { id:'size_sqmm', label:'Size (sq.mm)', type:'select', options:['16','25','35','50','70','95','120','150','185','240'] },
    { id:'length_m', label:'Length (m)', type:'number', placeholder:'100' },
    { id:'voltage_level', label:'Voltage Level', type:'select', options:['LT 433V','HT 11kV'] },
    { id:'from_point', label:'From Point', placeholder:'P-0005' },
    { id:'to_point', label:'To Point', placeholder:'P-0008' },
  ],
  rmu: [
    { id:'rmu_type', label:'RMU Type', type:'select', options:['SF6 RMU','Vacuum RMU','Air Insulated'] },
    { id:'num_ways', label:'No. of Ways', type:'select', options:['2','3','4','5','6'] },
    { id:'rating_amps', label:'Rating (A)', type:'number', placeholder:'630' },
    { id:'voltage_kv', label:'Voltage (kV)', type:'select', options:['11kV','33kV'] },
    { id:'make', label:'Make', placeholder:'ABB / Schneider' },
    { id:'installation_year', label:'Year', type:'number', placeholder:'2022' },
  ],
  cap_bank: [
    { id:'capacity_kvar', label:'Capacity (kVAR)', type:'number', placeholder:'300' },
    { id:'voltage_kv', label:'Voltage', type:'select', options:['11kV','33kV','433V'] },
    { id:'num_steps', label:'No. of Steps', type:'number', placeholder:'6' },
    { id:'control_type', label:'Control', type:'select', options:['Manual','Auto','APFC'] },
    { id:'make', label:'Make', placeholder:'EPCOS / Shreem' },
  ],
  la: [
    { id:'la_type', label:'Type', type:'select', options:['Gapless MOV','Expulsion Type','Station Class','Distribution Class'] },
    { id:'voltage_kv', label:'Voltage (kV)', type:'select', options:['9kV (11kV System)','30kV (33kV System)','3kV (LT)'] },
    { id:'discharge_kA', label:'Discharge (kA)', type:'select', options:['5kA','10kA','20kA'] },
    { id:'make', label:'Make', placeholder:'CG / Raychem / Oblum' },
    { id:'condition', label:'Condition', type:'select', options:['Good','Cracked','Flashover Marks','Replaced'] },
  ],
  streetlight: [
    { id:'lamp_type', label:'Lamp Type', type:'select', options:['LED','HPSV','MH','Fluorescent','CFL'] },
    { id:'wattage', label:'Wattage (W)', type:'number', placeholder:'45' },
    { id:'pole_type', label:'Pole Type', type:'select', options:['GI Pipe','Ornamental','Highma st'] },
    { id:'control', label:'Control', type:'select', options:['Timer','Photocell','Manual','Smart'] },
    { id:'circuit_no', label:'Circuit No.', placeholder:'SL-07' },
  ],
  service_conn: [
    { id:'conn_type', label:'Connection Type', type:'select', options:['Overhead Service','Underground Service','Aerial Bunch'] },
    { id:'cable_size', label:'Cable Size', type:'select', options:['6 sq.mm','10 sq.mm','16 sq.mm','25 sq.mm'] },
    { id:'consumer_type', label:'Consumer Type', type:'select', options:['Domestic','Commercial','Industrial','Agriculture'] },
    { id:'meter_no', label:'Meter/K.No.', placeholder:'K-00123456' },
    { id:'sanctioned_load', label:'Sanctioned Load (kW)', type:'number', placeholder:'2' },
  ],
  dtr_sp: [
    { id:'capacity_kva', label:'Capacity (kVA)', type:'select', options:['5','10','16','25','40'] },
    { id:'voltage_ratio', label:'Voltage Ratio', type:'select', options:['11kV/240V','11kV/433V'] },
    { id:'make', label:'Make / Year', placeholder:'BHEL/2022' },
    { id:'present_load_pct', label:'Load %', type:'number', placeholder:'65' },
    { id:'consumers_count', label:'Consumers', type:'number', placeholder:'8' },
    { id:'phase', label:'Phase', type:'select', options:['Single Phase'] },
    { id:'mounting', label:'Mounting', type:'select', options:['Pole Mounted','Plinth Mounted','Pad Mounted'] },
  ],
  iso: [
