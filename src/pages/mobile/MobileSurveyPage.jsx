...
const ASSET_FIELDS = {
  ...
  stay_11kv: [
    ...
    { id:'wire_dia', label:'Wire Dia', type:'select', options:['7/8 SWG','7/10 SWG','7/12 SWG'] },
  ...
  lattice_36: [
    { id:'structure_type', label:'Structure', type:'select', options:['Tension','Section','Angle','Terminal'] },
    { id:'voltage_level', label:'Voltage', type:'select', options:['11kV','33kV','66kV'] },
  ...
  ab_cable: [
    { id:'cable_type', label:'Cable Type', type:'select', options:['ABC 3.5 Core','ABC 4 Core','ABC 2 Core'] },
    { id:'size_sqmm', label:'Size (sq.mm)', type:'select', options:['16','25','35','50','70','95','120','150'] },
  ...
  rmu: [
    ...
    { id:'voltage_kv', label:'Voltage', type:'select', options:['11kV','33kV'] },
  ],
  cap_bank: [
  ...
  la: [
    ...
    { id:'voltage_kv', label:'Voltage (kV)', type:'select', options:['9kV (11kV)','30kV (33kV)','3kV (LT)'] },
    { id:'condition', label:'Condition', type:'select', options:['Good','Cracked','Flashover Marks','Replaced'] },
  ],
  streetlight: [
    { id:'lamp_type', label:'Lamp Type', type:'select', options:['LED','HPSV','MH','Fluorescent'] },
  ...
  service_conn: [
    { id:'conn_type', label:'Conn. Type', type:'select', options:['Overhead','Underground','Aerial Bunch'] },
    { id:'cable_size', label:'Cable Size', type:'select', options:['6 sq.mm','10 sq.mm','16 sq.mm','25 sq.mm'] },
    { id:'consumer_type', label:'Consumer', type:'select', options:['Domestic','Commercial','Industrial','Agriculture'] },
    { id:'sanctioned_load', label:'Load (kW)', type:'number', placeholder:'2' },
  ],
  dtr_sp: [
    { id:'capacity_kva', label:'Capacity (kVA)', type:'select', options:['5','10','16','25','40'] },
    { id:'voltage_ratio', label:'Voltage', type:'select', options:['11kV/240V','11kV/433V'] },
